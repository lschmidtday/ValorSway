 ...
 * This file demonstrates how to integrate Valorsway with a web frontend
 */

// For React/Vue/Angular applications
export class ValorswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ValorswayClient(provider, contractAddress);
